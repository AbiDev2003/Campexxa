...
module.exports.searchSuggest = async(req, res) => {
    try {
        const q = req.query.q || "";
...
module.exports.locationFilters = async(req, res) => {
    try {
...
module.exports.currencyRates = async(req, res) => {
    try {
...
module.exports.checkUsername = async (req, res) => {
  try {
    ...
    // allow same user (profile edit case)
    if (req.user && existingUser && existingUser._id.equals(req.user._id)) {
