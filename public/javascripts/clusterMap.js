...
const map = new mapboxgl.Map({
  ...
  style: "mapbox://styles/mapbox/outdoors-v12", //keep it all the time !
...
map.on("load", () => {
  ...
  map.addInteraction("click-unclustered-point", {
    ...
    handler: (e) => {
      console.log("🧪 RAW MAPBOX FEATURE:", e.feature);
      // console.log("🧪 MAPBOX PROPERTIES:", e.feature.properties);
